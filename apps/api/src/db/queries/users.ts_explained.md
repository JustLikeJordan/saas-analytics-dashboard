...
**Interview-ready line:** "The query module acts as a repository layer, decoupling business logic from the ORM. Services call `findUserByEmail()` without knowing or caring whether that's Drizzle, raw SQL, or an API call."
